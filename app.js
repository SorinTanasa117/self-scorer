...
let myTemplates = [];
let lifestyleData = {};
let positivesForMonth = [];

// --- DOM Elements (initialized in DOMContentLoaded) ---
let homePage, addPositivePage, useTemplatePage, signoutBtn, addPositiveBtnHome,
    useTemplateBtn, monthSelector, yearSelector, calendarEl, positivesListEl,
    dailyLogTitleEl, progressChartCanvas, lifestyleChartCanvas,
    lifestyleChartDrilldownContainer, drilldownTitle, drilldownChartCanvas,
    backToLifestyleChartBtn, taskDetailPopup, closeTaskDetailPopupBtn,
    taskDetailTitle, taskDetailContent, addPositiveForm, cancelPositiveBtn,
    saveTemplateBtn, difficultySlider, difficultyValue, difficultyHelpIcon,
    difficultyTooltip, closeTooltipBtn, positiveNameInput,
    positiveTemplatesInput, standardTemplatesOptions, myPositiveTemplatesInput,
    myTemplatesOptions, templateMonthSelector, templateYearSelector,
    templateCalendarEl, templateDayPositivesListEl, templateMasterListEl,
    searchMasterListInput, templateSelectAllBtn, saveFromTemplateBtnTop,
    saveFromTemplateBtnBottom, cancelFromTemplateBtn;
...
const renderApp = async () => {
    ...
    await renderProgressChart(activeRange);
...
const renderCalendar = async (month, year) => {
    ...
    if (currentUser) {
        ...
        try {
            ...
            positivesForMonth = monthPositives;
...
const renderProgressChart = async (range = 'week') => {
    if (myChart) {
        myChart.destroy();
    }
    const labels = [];
    ...
    myChart = new Chart(progressChartCanvas, {
        type: 'line',
        data: {
            labels: labels,
            datasets: [{
...
const renderLifestyleChart = async () => {
    ...
    const rangePositives = positivesForMonth.filter(p => p.date >= startStr && p.date <= endStr);
...
const init = async () => {
    ...
    await renderCalendar(currentMonth, currentYear);
    await renderPositivesForDay(selectedDate);
    await renderProgressChart('week');
    updateButtonStates();
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    addPositivePage = document.getElementById('add-positive-page');
    useTemplatePage = document.getElementById('use-template-page');
    signoutBtn = document.getElementById('signout-btn');
    addPositiveBtnHome = document.querySelector('.add-positive-btn');
    ...
    positivesListEl = document.getElementById('positives-list');
    ...
    addPositiveForm = document.getElementById('add-positive-form');
    cancelPositiveBtn = document.getElementById('cancel-positive-btn');
    saveTemplateBtn = document.getElementById('save-template-btn');
    difficultySlider = document.getElementById('positive-difficulty');
    difficultyValue = document.getElementById('difficulty-value');
    difficultyHelpIcon = document.getElementById('difficulty-help-icon');
    difficultyTooltip = document.getElementById('difficulty-tooltip');
    closeTooltipBtn = document.getElementById('close-tooltip-btn');
    positiveNameInput = document.getElementById('positive-name');
    positiveTemplatesInput = document.getElementById('positive-templates-input');
    standardTemplatesOptions = document.getElementById('standard-templates-options');
    myPositiveTemplatesInput = document.getElementById('my-positive-templates-input');
    myTemplatesOptions = document.getElementById('my-templates-options');
    templateMonthSelector = document.getElementById('template-month-selector');
    templateYearSelector = document.getElementById('template-year-selector');
    templateCalendarEl = document.getElementById('template-calendar');
    templateDayPositivesListEl = document.getElementById('template-day-positives-list');
    templateMasterListEl = document.getElementById('template-master-list');
    searchMasterListInput = document.getElementById('search-master-list');
    templateSelectAllBtn = document.getElementById('template-select-all-btn');
    saveFromTemplateBtnTop = document.getElementById('save-from-template-btn');
    saveFromTemplateBtnBottom = document.getElementById('save-from-template-btn-bottom');
    cancelFromTemplateBtn = document.getElementById('cancel-from-template-btn');
...
window.renderLifestyleChart = renderLifestyleChart;
window.renderLifestyleDrilldown = renderLifestyleDrilldown;
window.showTaskDetailPopup = showTaskDetailPopup;
Object.defineProperty(window, 'lifestyleData', {
    get: () => lifestyleData
});
Object.defineProperty(window, 'positivesForMonth', {
    set: (value) => { positivesForMonth = value; }
});
